    ...
    areas: [
      {
        ...
        fields: [
          ...
          { id: 'dayPeriod', type: 'dayperiod', row: 6, label: '날짜범위 예제', labelVisible: true, placeholder: '날짜 범위 선택', width: '190px', enabled: false, defaultValue: { start: todayDate, end: todayDate } },
