    ...
    areas: [
      {
        type: 'search',
        fields: [
          { id: 'defaultValueText', type: 'text', row: 1, label: '텍스트박스디폴트값넣기(textarea 도 같음)', defaultValue:'디폴트값', labelVisible: true, placeholder: '', maxLength: 50, width: '200px', enabled: true },
          { id: 'name', type: 'text', row: 1, label: '이름', labelVisible: true, placeholder: '이름 검색', maxLength: 50, width: '200px', enabled: true },
          { id: 'status', type: 'select', row: 1, label: '상태', labelVisible: true, options: getFieldOptions('status'), width: '150px', enabled: true },
          { id: 'orgText', type: 'text', row: 2, label: '조직예제', labelVisible: true, placeholder: '조직 선택', width: '150px', enabled: false },
          { id: 'orgPopupBtn', type: 'popupIcon', row: 2, label: '조직 선택', labelVisible: false, eventType: 'showOrgPopup', width: '30px', enabled: true },
          { id: 'userText', type: 'text', row: 2, label: '사용자예제', labelVisible: true, placeholder: '사용자 선택', width: '150px', enabled: false },
          { id: 'userPopupBtn', type: 'popupIcon', row: 2, label: '사용자 선택', labelVisible: false, eventType: 'showUserPopup', width: '30px', enabled: true },
          { id: 'testSearchBtn', type: 'button', row: 2, label: '팝업', labelVisible: false, eventType: 'testSearch', enabled: true },
          { id: 'status1', type: 'select', row: 3, label: '드롭리스트예제', labelVisible: true, options: getFieldOptions('org1'), width: '150px', enabled: true },
          { id: 'status2', type: 'select', row: 3, label: '드롭리스트예제', labelVisible: false, options: status2Options, width: '150px', enabled: true },
          { id: 'status3', type: 'select', row: 3, label: '드롭리스트예제', labelVisible: false, options: status3Options, width: '150px', enabled: true },
          { id: 'createdDate', type: 'day', row: 4, label: '일자예제', labelVisible: true, placeholder: '날짜 선택', width: '100px', enabled: false, defaultValue: todayDate },
          { id: 'monthExample', type: 'month', row: 4, label: '월예제', labelVisible: true, placeholder: '월 선택', width: '100px', enabled: false, defaultValue: todayDate },
          { id: 'labelExample', type: 'label', row: 4, label: '라벨 예제', labelVisible: true, width: '100px', enabled: true },
          { id: 'rangeStartDate', type: 'startday', row: 5, label: '기간(일자)예제', labelVisible: true, placeholder: '시작일 선택', width: '100px', enabled: false, defaultValue: todayDate },
          { id: 'rangeEndDate', type: 'endday', row: 5, label: ' ~ ', labelVisible: true, placeholder: '종료일 선택', width: '100px', enabled: false, defaultValue: todayDate },
          { id: 'rangeStartMonth', type: 'startmonth', row: 5, label: '기간(월)예제', labelVisible: true, placeholder: '시작월 선택', width: '100px', enabled: false, defaultValue: todayMonth },
          { id: 'rangeEndMonth', type: 'endmonth', row: 5, label: ' ~ ', labelVisible: true, placeholder: '종료월 선택', width: '100px', enabled: false, defaultValue: todayMonth },
          { id: 'dayPeriod', type: 'dayperiod', row: 6, label: '날짜범위 예제', labelVisible: true, placeholder: '날짜 범위 선택', width: '100px', enabled: false, defaultValue: { start: todayDate, end: todayDate } },
          { id: 'monthPeriod', type: 'monthperiod', row: 6, label: '월범위 예제', labelVisible: true, placeholder: '월 범위 선택', width: '100px', enabled: false, defaultValue: { start: todayMonth, end: todayMonth } },
      ...
      },
      {
        ...
        fields: [
          ...
          { id: 'resetBtn', type: 'button', row: 8, label: '초기화', eventType: 'reset', width: '80px', enabled: true },
          { id: 'popupBtn2', type: 'button', row: '8', label: '팝업 버튼', eventType: 'showPopup', width: '100px', enabled: true },
          { id: 'excelUploadBtn', type: 'button', row: '8', label: '엑셀업로드', eventType: 'showExcelUploadPopup', width: '100px', enabled: true },
          { id: 'tempUploadBtn', type: 'button', row: '9', label: 'common 팝업 버튼 및 이벤트 및 comfirm메시지 및 파일업로드기능 예제(ExcelUploadTemplateManage.jsx참조)', eventType: 'showTempUploadPopup', enabled: true },
        ],
      },
    ],
  };
