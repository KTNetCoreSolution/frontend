...
const UserCarLog = () => {
  ...
  const columns = [   
    ...
    { title: '운행자사번', field: 'DRIVER_EMPNO', width: 90, headerHozAlign: 'center', hozAlign: 'center'},
    { title: '운행자이름', field: 'DRIVER', width: 90, headerHozAlign: 'center', hozAlign: 'center'},
    { title: '작성자사번', field: 'EMPNO', width: 90, headerHozAlign: 'center', hozAlign: 'center'},
    { title: '작성자이름', field: 'EMPNM', width: 90, headerHozAlign: 'center', hozAlign: 'center'},
