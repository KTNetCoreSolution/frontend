    ...
    areas: [
      {
        type: 'search',
        fields: [
          { id: 'startDate', type: 'startday', row: 1, label: '기간', labelVisible: true, placeholder: '시작일 선택', width: '130px', height: '30px', backgroundColor: '#ffffff', color: '#000000', enabled: false, defaultValue: todayDate },
          { id: 'endDate', type: 'endday', row: 1, label: ' ~ ', labelVisible: true, placeholder: '종료일 선택', width: '130px', height: '30px', backgroundColor: '#ffffff', color: '#000000', enabled: false, defaultValue: todayDate },
          ...
          { id: 'userText', type: 'text', row: 1, label: '이름', labelVisible: true, width: '120px', height: '30px', backgroundColor: '#f0f0f0', color: '#000000', enabled: false },
