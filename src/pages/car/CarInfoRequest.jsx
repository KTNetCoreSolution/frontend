...
const CarListInfo = () => {
  ...
  const columns = [
    ...
    { title: '조직이관', field: 'CHG_ORG', minWidth: 150, maxWidth: 400, headerHozAlign: 'center', hozAlign: 'center' },
    { title: '변경내역', field: 'CHG_DATA', maxWidth: 400, headerHozAlign: 'center', hozAlign: 'center' },
    ...
    { title: '차명', field: 'CARNM2', minWidth: 150, maxWidth: 400, headerHozAlign: 'center', hozAlign: 'center' },
