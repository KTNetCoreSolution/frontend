    ...
    areas: [
      {
        ...
        fields: [
          ...
          { id: 'rangeStartDate', type: 'startday', row: 2, width:'96px', label: '', labelVisible: true, placeholder: '시작일 선택', enabled: false, defaultValue: today }, // 시작일 입력 (dayGubun: 'D'일 때 표시)
          { id: 'rangeEndDate', type: 'endday', row: 2, width:'96px', label: ' ~ ', labelVisible: true, placeholder: '종료일 선택', enabled: false, defaultValue: today }, // 종료일 입력 (dayGubun: 'D'일 때 표시)
        ],
      },
      {
        type: 'buttons',
